...
require "/scripts/tooltip/scriptHooks.lua"
require "/scripts/tooltip/tooltip_util.lua"
...
function tooltip.draw(ttip, wPos, wSize)
  ...
  local p = tooltip.offset(wPos, wSize, labelSize, ttip.direction or "top", margin + padding)
